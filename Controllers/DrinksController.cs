...
namespace WebBanNuocMVC.Controllers
{
    public class DrinksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DrinkId,DrinkName,CategoryId,Price,Description,Image")] Drink drink)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DrinkId,DrinkName,CategoryId,Price,Description,Image")] Drink drink)
        {
            if (id != drink.DrinkId)
            {
                return NotFound();
